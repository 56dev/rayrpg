...
void RRPG_DEBUG_draw_grid(int grid_side_length, int camera_width, int camera_height); //Draws the grid semitransparently
...
void RRPG_move_player(
    ...
    Vector2Grid g_pos_end); // moves the player in that RPG-like way